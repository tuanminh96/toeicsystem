	...
	<div class="wrapper d-flex">
		<div class="sidebar">
			...
			<ul>
				...
				<span class="glyphicon glyphicon-tasks">&nbsp;</span>Quản lý Đề thi</a></li> --%>
				<%-- <li class="side-bar"><a
					href='<c:url value="/admin/exam-approve"/>'> <span
						class="glyphicon glyphicon-tasks">&nbsp;</span>Xét duyệt đề thi
				</a></li> --%>
				<li class="side-bar"><a href='<c:url value="/admin/group"/>'>
				<span class="glyphicon glyphicon-tasks">&nbsp;</span>Quản lý Nhóm học
				</a></li>
			</ul>
		</div>
	</div>
