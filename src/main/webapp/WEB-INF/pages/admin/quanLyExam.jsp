...
<div class="col-md-9 animated bounce">
    ...
    <button class="btn btn-success btnAddExam" data-toggle="modal"
            data-target="#examModal">Thêm mới
    </button>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="examTitle" class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Level</label>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input id="examDescription" class="form-control">
                    </div>

                    <div class="form-group col-md-6">
                        <label>Ảnh bài thi thử</label>
                        <input type="file" id="fileThumbnail" class="form-control" required accept="image/*">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="fileExcel">File nội dung (Excel):</label>
                        <input type="file" class="form-control" id="fileQuestionExcel" name="file_Excel" required
                               accept=".xlsx">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="fileAnhCauHoi">File ảnh câu hỏi:</label>
                        <input type="file" class="form-control" id="fileQuestionImageLst" name="file_Image_Question"
                               required accept="image/*" multiple>
                    </div>

                    <div class="form-group col-md-6">
                        <label for="fileNghe">File nghe câu hỏi:</label>
                        <input type="file" class="form-control" id="fileQuestionAudioLst" name="file_Excel" required multiple
                               accept=".mp3,.org">
                    </div>
                </div>
            </div>
