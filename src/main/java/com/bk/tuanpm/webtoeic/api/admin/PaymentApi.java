...
public class PaymentApi {
	...
	@PostMapping(value = "/api/processPayment", produces = MediaType.APPLICATION_JSON_VALUE) 
	public ResponseEntity<String> processPayment(Model model, @RequestBody PaymentDTO paymentDTO, HttpServletResponse response) throws IOException {
		...
		return new ResponseEntity<String>(queryUrl, HttpStatus.OK);
	}
