        ...
        <div class="row mt-4">
            <div class="col-12 col-lg-10 offset-lg-1">
                <div class="row">
                    <div class="col-12">
                        <div class="text-center text-150">
                            ...
                            <span class="text-default-d3">Thông tin thanh toán</span>
                        </div>
                    </div>
                </div>
                <!-- .row -->
                ...
                <div class="mt-4">
                    ...
                    <hr />
                    <div>
                        <span class="text-secondary-d1 text-105">Cảm ơn bạn đã tin tưởng chúng tôi</span>
                        <a href="#" class="btn btn-info btn-bold px-4 float-right mt-3 mt-lg-0">Tải về</a>
                    </div>
                </div>
            </div>
        </div>
