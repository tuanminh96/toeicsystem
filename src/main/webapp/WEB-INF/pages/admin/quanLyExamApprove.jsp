    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label>Tên bài thi thử</label> <input id="examTitle"
                                                              class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Level</label>
                    ...
                    <div class="form-group col-md-12">
                        <label>Mô tả bài thi</label> <input id="examDescription"
                                                            class="form-control">
                    </div>

                    <div class="form-group col-md-6">
                        <label>Ảnh bài thi thử</label> <input type="file"
                                                              id="fileThumbnail" class="form-control" required
                                                              accept="image/*">
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnAddNewExam" class="btn btn-primary">Xác
                    nhận</button>
