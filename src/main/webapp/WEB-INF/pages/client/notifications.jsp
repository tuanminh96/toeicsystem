            ...
            <div class="box shadow-sm rounded bg-white mb-3">
                ...
                <div class="box-body p-0">
                    <div class="p-3 d-flex align-items-center bg-light border-bottom osahan-post-header">
                        ...
                        <a href="<%=request.getContextPath()%>/detailnoti/1"><div class="text-truncate">Nhận xét từ người hướng dẫn</div>
                            <div class="small">Income tax sops on the cards, The bias in VC funding, and other top news for you</div></a>
                        </div>
            ...
            <div class="box shadow-sm rounded bg-white mb-3">
                ...
                <div class="box-body p-0">
                    <div class="p-3 d-flex align-items-center border-bottom osahan-post-header">
                        ...
                        <div class="font-weight-bold mr-3">
                            <div class="text-truncate">Nhận xét từ người hướng dẫn</div>
