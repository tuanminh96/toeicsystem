                            ...
                            <div class="panel-body">
                                ...
                                <input type="hidden" value="${part5.get(0).number}"
                                       id="firstquest"> <input type="hidden"
                                                               value="${part5count+part6count+part7count}"
                                                               id="totalquest">
                            </div>
                        </div>
                        ...
                        <c:forEach items="${partReading}" var="part" varStatus="index">
                            <c:choose>
                                <c:when test="${index.count=='1'}">
                                    <li class="active"><a partid="${part.idPart}"
                                                          href="#${part.idPart}">${part.partName}</a></li>
                                </c:when>
                                <c:otherwise>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button onclick="javascript:clickSubmitReading()" type="button"
