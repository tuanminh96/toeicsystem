...
<div class="leftbar col-md-3">
	<div class="wrapper d-flex">
		<div class="sidebar">
        	...
        	<li class="side-bar"><a
					href='<c:url value="/manager/exam-approve"/>'> <span
						class="glyphicon glyphicon-tasks">&nbsp;</span>Xét duyệt đề thi
				</a></li>     
			          <li class="side-bar main-menu">
            <a href="<c:url value='/manager/group-approve' />">
              <span class="glyphicon glyphicon-th-list">&nbsp;</span>Xem nhóm học tập</a>
          </li>  
          <li class="side-bar main-menu">
            <a href="<c:url value='/manager/tai-khoan' />">
              <span class="glyphicon glyphicon-th-list">&nbsp;</span>Quản lý Người dùng</a>
          </li>
        </ul>
		</div>
	</div>
